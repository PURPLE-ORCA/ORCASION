  ...
  return (
    <form
      className={cn(
        ...
        "bg-gray-900/50 dark:bg-gray-900/50 border border-purple-500/20",
        value && "bg-gray-800/70 border-purple-500/40"
      )}
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="text-gray-400 dark:text-gray-400 text-sm sm:text-base font-normal pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate"
            >
